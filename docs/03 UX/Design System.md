...
- Component states beyond what's listed in §8 (e.g., focus-visible states for web/keyboard navigation) will need specifying as Frontend Architecture (Phase 11) gets underway.
